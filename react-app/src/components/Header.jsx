...
const Header = () => {
    ...
    const changeLanguage = (langCode) => {
        ...
        // Use /auto/target_lang to let Google detect source language
        // Or strictly /hi/en if we know source is Hindi
    ...
    return (
        <header>
            ...
            <div 
                onClick={() => window.location.href='/join-our-team'} 
                    ...
                    <div className="container">
                        ...
                        <div className="header_mobile_navbar hidden-desktop">
                            <div className="top_barNav">
                                <div className={`menu_open ${isMenuOpen ? 'active' : ''} menu-toggle-btn-custom`} onClick={toggleMenu}>open</div>
                                <div className={`nav_slidebar ${isMenuOpen ? 'active' : ''}`}>
                                    <ul className="menu_bar">
                                        ...
                                        <li className="mobile-join-rrc-item">
                                            <a href="#" className="mobile-join-rrc-btn">Join RRC</a>
                                        </li>
                                    </ul>
                                    <div className="courtesy_bar">
